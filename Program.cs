...
// 8 7,8 -7,1 9
        ...
        // Console.Write("Введите кол-во столбов массива: ");
...
// Console.Write("Введите кол-во строк m массива: ");
// int m = Convert.ToInt32(Console.ReadLine());
// Console.Write("Введите кол-во столбцов n массива: ");
// int n = Convert.ToInt32(Console.ReadLine());
// double[,] randomArray = new double[m,n];
...
Console.Write("Введите кол-во строк m массива: ");
int m = Convert.ToInt32(Console.ReadLine());
Console.Write("Введите кол-во строк n массива: ");
int n = Convert.ToInt32(Console.ReadLine());
